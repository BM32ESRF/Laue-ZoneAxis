...
class Predictor:
    ...
    def generate_orientation(self, s_tth, s_chi, predicted_hkl, spot1_ind, spot2_ind, emax=23):
        ...
        >>> s_tth = 2* np.array([21.407846, 23.937868, 22.2405  , 24.153408, 22.695541, 23.248268,
       ...
       64.78367 , 64.85807 , 64.46475 , 67.316986], dtype=np.float32)
        >>> s_chi = np.array([-8.20532703e+00,  3.21790009e+01, -3.41909170e+00,  2.74034386e+01,
       ...
       -8.49700642e+00, -1.18187237e+01, -2.43182430e+01,  1.39376507e+01],
      dtype=np.float32)
        >>> predicted_hkl = np.array([
            [-8.0, 2.0, 7.0],
            [0.0, -5.0, -4.0],
